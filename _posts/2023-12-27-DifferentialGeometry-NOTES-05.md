...
> ##### 定理5.3
> 如果由给出的两个二次微分形式$$\varphi$$、$$\psi$$满足Gauss-Codazzi方程
$$
\begin{cases}
\begin{aligned}
&b_{1 1} b_{2 2} - (b_{1 2})^2 = R_{1 2 1 2} \\
