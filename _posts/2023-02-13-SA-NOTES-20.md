...
这样在对应的patch上就可以利用[参数化](/blog/2022/SA-NOTES-02/#mesh-embedding)这样的技术将它们映射到相同的参数域上，进而得到分片网格的对应关系。
...
如果两个曲面之间仅相差一个等距变换，我们则可以使用[heat kernel signature](/blog/2022/SA-NOTES-14/#heat-kernel-signature)来计算曲面对应。此时只需要分别计算曲面上每个顶点的descriptor然后进行匹配即可。
...
<img src="https://i.imgur.com/931ytov.png" width="80%">
