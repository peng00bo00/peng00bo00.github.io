...
在前面的课程中我们介绍过[切空间](/blog/2022/SA-NOTES-05/#tangent-space)的概念。这里我们主要使用它的第二种定义，即切空间是$$p$$点附近局部参数化映射$$g$$的微分$$dg$$的像。
...
利用向量场我们还可以重新认识[测地线](/blog/2022/SA-NOTES-08)。回忆[测地线方程](/blog/2022/SA-NOTES-08/#derivative-formulas)指出测地线没有切平面上的加速度，只要出切平面的加速度。
