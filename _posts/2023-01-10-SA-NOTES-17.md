...
类似地，**regularized PCA**算法可以等价地表示为Stiefel流形上的优化。我们[稍后](/2023/01/10/SA-NOTES-17.html#manifold-optimization-for-pca-problems)会介绍具体的推导过程。实际上很多PCA算法的变体都可以转化为Stiefel流形上的优化问题。
